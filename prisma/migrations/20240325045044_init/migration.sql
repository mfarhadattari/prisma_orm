...
CREATE TABLE "pofiles" (
    ...
    CONSTRAINT "pofiles_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "pofiles_userId_key" ON "pofiles"("userId");

-- AddForeignKey
ALTER TABLE "pofiles" ADD CONSTRAINT "pofiles_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
